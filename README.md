...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-04 04:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5ccea662-5f0d-466f-913e-3a9060500cac.git
$ cd 5ccea662-5f0d-466f-913e-3a9060500cac
```
